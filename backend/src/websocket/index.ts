        ...
        try {
            ...
            switch (parsedMessage.type) {
                ...
                case WsMessageType.JOIN_LOBBY:
                    ...
                    break;
                case WsMessageType.LEAVE_LOBBY:
                    this.handleLeaveLobby(client);
                    break;
                case WsMessageType.LOBBY_LIST_REQUEST:
                    this.handleLobbyListRequest(client);
                    break;
                case WsMessageType.START_GAME_REQUEST:
                    this.handleStartGameRequest(client);
                    break;
    ...
    private handleGameAction(client: WsClient, message: WsIncomingMessage): void {
        ...
        switch (message.type) {
            case WsMessageType.PLAY_CARD:
                ...
                break;
            case WsMessageType.DRAW_CARD:
                actionSuccessful = game.drawCard(client.clientId);
                break;
            case WsMessageType.CHALLENGE_BOOM:
                actionSuccessful = game.challengeBoom(client.clientId);
                break;
            case WsMessageType.PASS_TURN:
                actionSuccessful = game.passTurn(client.clientId);
                break;
            case WsMessageType.CALL_BOOM:
                actionSuccessful = game.callBoom(client.clientId);
                break;
            case WsMessageType.WILD_COLOR_PICKED:
