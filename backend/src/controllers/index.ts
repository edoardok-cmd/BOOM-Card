 ...
 */;
type AuthenticatedAsyncFunction = (req: RequestWithUser, res: Response, next: NextFunction) => Promise<void>,
...
class CardController {
  ...
  status: 'used',
     ...
     */,
  validateCreateCard: (req: Request, res: Response, next: NextFunction) => {
...
// to create a single, clean entry point for all controllers: // export * from './userController',
