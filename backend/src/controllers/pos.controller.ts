...
export class PosController {
     ...
     */
    public static validateProcessTransaction = (req: Request, res: Response, next: NextFunction) => {
     ...
     */
    public static processTransaction = async (req: Request, res: Response, next: NextFunction) => {
        try {
     ...
     */
    public static refundTransaction = async (req: Request, res: Response, next: NextFunction) => {
        try {
     ...
     */
    public static voidTransaction = async (req: Request, res: Response, next: NextFunction) => {
        try {
     ...
     */
    public static getTransactionDetails = async (req: Request, res: Response, next: NextFunction) => {
        try {
     ...
     */
    public static getAllTransactions = async (req: Request, res: Response, next: NextFunction) => {
        try {
     ...
     */
    public static getPosSummary = async (req: Request, res: Response, next: NextFunction) => {
        try {
...
const paymentService = {
    processPayment: async (details: PaymentRequest): Promise<PaymentServiceResult> => {
...
const orderService = {
    createOrder: async (details: OrderCreateRequest): Promise<OrderServiceResult> => {
