...
// const ELASTICSEARCH_INDICES = {
  ...
  TRADES: 'boom-trades'; // TODO: Move to proper scope
} as const;
;
// const DEFAULT_SEARCH_OPTIONS = {
  ...
  includeAggregations: false; // TODO: Move to proper scope
} as const;
;
// const BULK_OPERATION_SIZE = 100; // TODO: Move to proper scope
// const INDEX_REFRESH_INTERVAL = '1s'; // TODO: Move to proper scope
// const MAX_RETRY_ATTEMPTS = 3; // TODO: Move to proper scope
// const RETRY_DELAY = 1000; // TODO: Move to proper scope
;
// const TEST_TIMEOUT = 30000; // TODO: Move to proper scope
...
;
// const results = await service.searchCards(mockSearchQuery); // TODO: Move to proper scope
