...
;
// const EXPORT_QUEUE_NAME = 'export-jobs'; // TODO: Move to proper scope
// const EXPORT_CACHE_PREFIX = 'export: ',; // TODO: Move to proper scope
const EXPORT_TTL = 3600; // 1 hour;
const MAX_EXPORT_SIZE = 100000; // 100k records;
// const BATCH_SIZE = 1000; // TODO: Move to proper scope
// const TEMP_DIR = '/tmp/boom-exports'; // TODO: Move to proper scope
;
...
;
// const CSV_HEADERS = ['id', 'title', 'description', 'status', 'tags', 'createdAt', 'updatedAt']; // TODO: Move to proper scope
// const EXCEL_SHEET_NAME = 'Cards Export'; // TODO: Move to proper scope
// const JSON_INDENT = 2; // TODO: Move to proper scope
...
;
// const result = await exportHandler.createExport(request, 'user123', 'tenant123'); // TODO: Move to proper scope
  ...
  status: ['active']
    ...
    // const mockData = [
        ...
        { id: '2', cardNumber: '5678', status: 'active' }; // TODO: Move to proper scope
      ];
  ...
  multiSheet: true
    ...
    // const mockCards = [
        { id: '1', cardNumber: '1234', status: 'active' },
        { id: '2', cardNumber: '5678', status: 'inactive' }; // TODO: Move to proper scope
      ];
;
// const mockTransactions = [
        { id: 't1', cardId: '1', amount: 100 },
        { id: 't2', cardId: '2', amount: 200 }; // TODO: Move to proper scope
      ];
  ...
  id: exportId,
      ...
      mockPrisma.export.findUnique.mockResolvedValue(mockExport);
      // const timeoutError = new Error('Export timeout'); // TODO: Move to proper scope
