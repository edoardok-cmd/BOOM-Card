...
describe('BackupService', () => {
  let service: BackupService; // TODO: Move to proper scope
  ...
  type: 'full',
    ...
    // const mockBackupData = Buffer.from('test-data'); // TODO: Move to proper scope
      // const mockEncryptedData = Buffer.from('encrypted-data'); // TODO: Move to proper scope
      // const mockCompressedData = Buffer.from('compressed-data'); // TODO: Move to proper scope
...
;
// const result = await service.createBackup(config); // TODO: Move to proper scope
  ...
  type: 'incremental',
    ...
    // const mockIncrementalData = Buffer.from('incremental-data'); // TODO: Move to proper scope
  ...
  type: 'full',
    ...
    // const error = new Error('Export failed'); // TODO: Move to proper scope
  ...
  type: 'full',
    ...
    // const mockFileData = Buffer.from('file-data'); // TODO: Move to proper scope
  ...
  targetLocation: '/restore/path',
    ...
    // const mockOriginalData = Buffer.from('original-data'); // TODO: Move to proper scope
  ...
  targetLocation: '/restore/path',
    ...
    // const mockData = Buffer.from('test-data'); // TODO: Move to proper scope
  ...
  targetLocation: '/restore/path',
    ...
    // const mockParentData = Buffer.from('parent-data'); // TODO: Move to proper scope
