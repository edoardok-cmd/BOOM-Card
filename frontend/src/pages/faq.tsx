...
export default function FAQ() {
  ...
  const faqs: FAQItem[] = [
    ...
    },
    {
      ...
      answer: t('faq.items.paymentMethods.a') || 'We accept all major credit and debit cards (Visa, Mastercard, American Express) as well as PayPal. All payments are processed securely through Stripe.'
    },
    {
      category: 'billing',
